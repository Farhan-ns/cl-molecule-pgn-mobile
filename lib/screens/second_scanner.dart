...
class SecondScannerScreen extends StatefulWidget {
  const SecondScannerScreen({Key? key}) : super(key: key);

  @override
  State<SecondScannerScreen> createState() => _SecondScannerScreenState();
}

class _SecondScannerScreenState extends State<SecondScannerScreen> {
  ...
  _postCode(Barcode scannedData) async {
    ...
    try {
      var response = await Network().postData(data, endpointSecondScan);
